	...
	function widget($args, $instance) {
		...
		<div class="widget-text wp_widget_plugin_box">
			<div class="footer-logos">
                <div class="calcagni-logo"><a href="http://calcagni.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-logos/calcagni-logo.png"></a></div>
