			...
			$burial_date = '';	
			  ...
			  //block mode
			    $html .= '<div class="wpfh_obit' . $class . '">							
										...
										<a href="'.wpfh_obit_page($r[$i]['id']).'"><img src=" ' . content_url() . '/plugins/wp-funeral-press/thumbs.php?src=' .get_real_image_path ( $r[$i]['photo'] ). '&w='.get_option('wpfh_obitsh_w').'&h='.get_option('wpfh_obitsh_h').'"></a>' . $vet . '
										</div>
			...
			///thumbnail mode
			  ...
			  $html .= '<div class="wpfh_obit_thumbnail' . $class . '">			
							...
							<div class="wpfh_obit_thumbnail_image">
								<a href="'.wpfh_obit_page($r[$i]['id']).'"><img src=" ' . content_url() . '/plugins/wp-funeral-press/thumbs.php?src=' .get_real_image_path ( $r[$i]['photo'] ). '&w='.get_option('wpfh_obitsh_w').'&h='.get_option('wpfh_obitsh_h').'"></a>
							</div>
