    ...
    <ul class="envoo-admin-menu">
        ...
        <li>
            ...
            <ul class="envoo-admin-submenu">
                ...
                <li><a <?php if (isset($_GET['sub_page']) && $_GET['sub_page'] == "options_social_accounts") echo 'id="selected-menu-subitem"'; ?> href="themes.php?page=theme_options&sub_page=options_social_accounts"><i class="fa fa-area-chart"></i><?php _e("Analytics", ANPS_TEMPLATE_LANG); ?></a></li>
