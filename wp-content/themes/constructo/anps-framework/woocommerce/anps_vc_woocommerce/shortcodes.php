   ...
   "params" => array(
      ...
      array(
       ...
       array(
         ...
         "param_name" => "orderby",
         "value" => array(__("Date", ANPS_TEMPLATE_LANG)=>'date', __("None", ANPS_TEMPLATE_LANG)=>'none', __("ID", ANPS_TEMPLATE_LANG)=>'ID', __("Title", ANPS_TEMPLATE_LANG)=>'title', __("Name", ANPS_TEMPLATE_LANG)=>'name', __("Modified", ANPS_TEMPLATE_LANG)=>'modified', __("Random", ANPS_TEMPLATE_LANG)=>'rand')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
         ...
         "param_name" => "order",
         "value" => array(__("Descending", ANPS_TEMPLATE_LANG)=>'desc', __("Ascending", ANPS_TEMPLATE_LANG)=>'asc') 
       )
    )
));
...
vc_map( array(
   ...
   "params" => array(
       ...
       array(
         ...
         "heading" => __("Order by", ANPS_PLUGIN_LANG),
         "param_name" => "orderby",
         "value" => array(__("Title", ANPS_TEMPLATE_LANG)=>'title', __("None", ANPS_TEMPLATE_LANG)=>'none', __("ID", ANPS_TEMPLATE_LANG)=>'ID', __("Date", ANPS_TEMPLATE_LANG)=>'date', __("Name", ANPS_TEMPLATE_LANG)=>'name', __("Modified", ANPS_TEMPLATE_LANG)=>'modified', __("Random", ANPS_TEMPLATE_LANG)=>'rand')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
         "heading" => __("Order", ANPS_PLUGIN_LANG),
         "param_name" => "order",
         "value" => array(__("Ascending", ANPS_TEMPLATE_LANG)=>'asc', __("Descending", ANPS_TEMPLATE_LANG)=>'desc') 
       )
      )
    )
);
   ...
   "params" => array(
      ...
      array(
       ...
       array(
         ...
         "heading" => __("Order by", ANPS_PLUGIN_LANG),
         "param_name" => "orderby",
         "value" => array(__("Name", ANPS_TEMPLATE_LANG)=>'name', __("None", ANPS_TEMPLATE_LANG)=>'none', __("ID", ANPS_TEMPLATE_LANG)=>'ID', __("Date", ANPS_TEMPLATE_LANG)=>'date', __("Title", ANPS_TEMPLATE_LANG)=>'title', __("Modified", ANPS_TEMPLATE_LANG)=>'modified', __("Random", ANPS_TEMPLATE_LANG)=>'rand')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
       ...
       array(
         ...
         "value" => array(__("Yes", ANPS_TEMPLATE_LANG)=>'1', __("No", ANPS_TEMPLATE_LANG)=>'0') 
       )
      )
    )
);
