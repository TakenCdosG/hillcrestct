    ...
    <div class="content-inner envoo-dummy">
        ...
        <div class="input">
            <center>
                ...
                <div class="demo-buttons">
                    <input type="submit" name="dummy2" class="dummy" <?php if ($dummy->select()) : ?> onclick = "return dummy(); " id="dummy-twice"<?php endif; ?> value="<?php _e("Insert dummy content", ANPS_TEMPLATE_LANG); ?>" />
                    <a class="launch" href="http://anpsthemes.com/constructo/" target="_blank">launch demo preview</a>
                </div>
            </center>
        </div>
        ...
        <div class="input">
            <center>
                ...
                <div class="demo-buttons">
                    <input type="submit" name="dummy3" class="dummy" <?php if ($dummy->select()) : ?> onclick = "return dummy(); " id="dummy-twice"<?php endif; ?> value="<?php _e("Insert dummy content", ANPS_TEMPLATE_LANG); ?>" />
        ...
        <div class="input">
            <center>
                ...
                <div class="demo-buttons">
                    <input type="submit" name="dummy4" class="dummy" <?php if ($dummy->select()) : ?> onclick = "return dummy(); " id="dummy-twice"<?php endif; ?> value="<?php _e("Insert dummy content", ANPS_TEMPLATE_LANG); ?>" />
        ...
        <div class="input">
            <center>
                ...
                <div class="demo-buttons">
                    <input type="submit" name="dummy5" class="dummy" <?php if ($dummy->select()) : ?> onclick = "return dummy(); " id="dummy-twice"<?php endif; ?> value="<?php _e("Insert dummy content", ANPS_TEMPLATE_LANG); ?>" />
